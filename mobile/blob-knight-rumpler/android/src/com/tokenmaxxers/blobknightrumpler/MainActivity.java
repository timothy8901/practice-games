package com.tokenmaxxers.blobknightrumpler;
...
public class MainActivity extends Activity {
    ...
    public void onBackPressed() {
        ...
        web.evaluateJavascript("(window.BKR && BKR.back) ? BKR.back() : false", new ValueCallback<String>() {
            @Override
    ...
    protected void onPause() {
        ...
        web.evaluateJavascript("window.BKR && BKR.appPause && BKR.appPause()", null);
        web.onPause();
        web.pauseTimers();
        super.onPause();
    }
